...
import ru.skillbranch.devintensive.vewmodels.ProfileViewModel
...
viewModel.switchTheme()
    ...
    private fun saveProfileInfo(){
        var rep:String
        if (et_repostory.text.toString().contains("https://github.com")){
            rep=et_repostory.text.toString()
        }else{
            rep="Невалидный адрес репозитория"
        }
        Profile(
